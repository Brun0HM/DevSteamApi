...
namespace DevSteamAPI.Controllers
{
    ...
    public class ItemCarrinhosController : ControllerBase
    {
        ...
        // GET: api/ItemCarrinhos/CalculateTotal/5
        ...
        // PUT: api/ItemCarrinhos/UpdateCarrinhoTotal/5
        [HttpPut("UpdateCarrinhoTotal/{id}")]
        public async Task<IActionResult> UpdateCarrinhoTotal(Guid id)
        {
